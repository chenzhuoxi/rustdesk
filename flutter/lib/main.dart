...
void runMobileApp() async {
  ...
  // Initialize Pixel Fold / foldable device detection.
  // Must be called before runApp() so that foldable state is available
  // when the first frame is built.
  if (isAndroid) FoldableHelper.instance.init();
